...
public class VentanaCargaGlobal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setBounds(160, 20, 300, 24);
        ...
        jButton1.setBounds(410, 150, 120, 40);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (this.path != "") {
            ...
            JOptionPane.showMessageDialog(null, "Debes seleccionar un archivo", "Información", JOptionPane.INFORMATION_MESSAGE);
        }
